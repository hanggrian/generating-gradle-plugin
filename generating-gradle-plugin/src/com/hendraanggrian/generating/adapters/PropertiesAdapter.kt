...
import com.hendraanggrian.generating.PropertiesRSpec
...
internal class PropertiesAdapter(
    private val configuration: PropertiesRSpec,
    ...
    override fun process(typeBuilder: TypeSpecBuilder, file: File): Boolean {
        ...
        if (file.extension == "properties") {
            when {
                configuration.writeResourceBundle.get() && file.isResourceBundle() -> {
